...
import type { MemberResource } from '@src/api/MembershipApplicationResource';
...
import type { UpdateMembershipRequest } from '@src/api/UpdateMembershipApplicationRequest';
...
const getAddressData = (): UpdateMembershipRequest => {
	return {
...
const submit = async (): Promise<void> => {
	...
	props.memberResource.put( getAddressData() ).then( ( addressData: Address ) => {
		isValidating.value = false;
		emit( 'address-updated', { membershipAddress } );
	} ).catch( ( error: string ) => {
		isValidating.value = false;
