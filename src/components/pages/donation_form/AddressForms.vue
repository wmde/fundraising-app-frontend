<template>
	<form
		...
		class="address-type-form"
		:class="{ visible: addressType === AddressTypeModel.PERSON || addressType === AddressTypeModel.UNSET }"
		action="/donation/add"
		method="post"
		@submit.prevent
	>
	...
	<form
		...
		class="address-type-form"
		:class="{ visible: addressType === AddressTypeModel.COMPANY }"
		action="/donation/add"
		method="post"
		@submit.prevent
	>
	...
	<form
		...
		class="address-type-form"
		:class="{ visible: addressType === AddressTypeModel.EMAIL }"
		action="/donation/add"
		method="post"
		@submit.prevent
	>
