<template>
	<RadioField
		...
		:label="$t( 'membership_form_salutation_label' )"
		:options="salutationFormOptions"
		:show-error="showError.salutation"
		:error-message="$t( 'membership_form_salutation_error' )"
	...
	<SelectField
		...
		:label="$t( 'membership_form_academic_title_label' )"
		:options="[
			{ label: $t( 'membership_form_academic_title_option_none' ), value: '' },
			{ label: 'Dr.', value: 'Dr.' },
	...
	<TextField
		...
		:error-message="$t( 'membership_form_firstname_error' )"
		autocomplete="given-name"
		:label="$t( 'membership_form_firstname_label' )"
		:placeholder="$t( 'membership_form_firstname_placeholder' )"
		:is-max-width-field="true"
	...
	<TextField
		...
		:error-message="$t( 'membership_form_lastname_error' )"
		autocomplete="family-name"
		:label="$t( 'membership_form_lastname_label' )"
		:placeholder="$t( 'membership_form_lastname_placeholder' )"
		placeholder-warning="membership_form_lastname_placeholder_warning"
		:is-max-width-field="true"
	...
	<TextField
		...
		:error-message="$t( 'membership_form_companyname_error' )"
		autocomplete="organization"
		:label="$t( 'membership_form_companyname_label' )"
		:placeholder="$t( 'membership_form_companyname_placeholder' )"
		:is-max-width-field="true"
...
interface Props {
	...
	addressTypesToShowPersonalFields?: string[];
}

const props = withDefaults( defineProps<Props>(), {
	addressTypesToShowPersonalFields: () => [ 'person' ],
} );
...
const showCompanyFields = computed( () => props.addressType === 'firma' );
