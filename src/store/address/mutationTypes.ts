...
export const SET_NEWSLETTER: string = 'SET_NEWSLETTER';
export const SET_RECEIPT: string = 'SET_RECEIPT';
export const SET_VALIDITY: string = 'SET_VALIDITY';
export const INITIALIZE_ADDRESS: string = 'INITIALIZE_ADDRESS';
