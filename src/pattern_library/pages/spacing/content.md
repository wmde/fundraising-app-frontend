This defines variables to handle consistent spacing that scales based on viewport width. They're used for defining the space between elements mostly as padding or margins.
