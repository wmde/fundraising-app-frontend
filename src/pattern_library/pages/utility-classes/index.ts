...
import stretchSingleContentCard from '@src/pattern_library/css/utilities/stretch-single-content-card.css?raw';
...
const codeSamples = [
	...
	{ name: 'stretch-single-content-card.css', code: stretchSingleContentCard },
